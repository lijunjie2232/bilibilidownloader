...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.login_op.setObjectName(u"login_op")
        self.setting_op = QAction(MainWindow)
        self.setting_op.setObjectName(u"setting_op")
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.download_list_text = QLabel(self.centralwidget)
        self.download_list_text.setObjectName(u"download_list_text")
        ...
        self.download_list.setStyleSheet(u"QListWidget::item {\n"
...
"}")
        self.download_list.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.download_list.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.cancle_all_btn = QPushButton(self.centralwidget)
        self.cancle_all_btn.setObjectName(u"cancle_all_btn")
        self.cancle_all_btn.setGeometry(QRect(535, 60, 96, 32))
        self.pause_all_btn = QPushButton(self.centralwidget)
        self.pause_all_btn.setObjectName(u"pause_all_btn")
        self.pause_all_btn.setGeometry(QRect(425, 60, 96, 32))
        self.resume_all_btn = QPushButton(self.centralwidget)
        self.resume_all_btn.setObjectName(u"resume_all_btn")
        ...
        self.head_label.setPixmap(QPixmap(u"C:/Pictures/547288f2178d80b0bba95d1c37d14b38.jpeg"))
        self.head_label.setScaledContents(True)
        self.link_type_selector = QToolButton(self.centralwidget)
        self.link_type_selector.setObjectName(u"link_type_selector")
        self.link_type_selector.setGeometry(QRect(10, 10, 100, 32))
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.link_type_selector.sizePolicy().hasHeightForWidth())
        ...
        self.link_type_selector.setPopupMode(QToolButton.ToolButtonPopupMode.MenuButtonPopup)
        self.link_type_selector.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.login_op.setText(QCoreApplication.translate("MainWindow", u"logout", None))
        self.setting_op.setText(QCoreApplication.translate("MainWindow", u"settings", None))
        self.download_list_text.setText(QCoreApplication.translate("MainWindow", u"Download List", None))
        self.cancle_all_btn.setText(QCoreApplication.translate("MainWindow", u"\u5168\u90e8\u53d6\u6d88", None))
        self.pause_all_btn.setText(QCoreApplication.translate("MainWindow", u"\u5168\u90e8\u6682\u505c", None))
        self.resume_all_btn.setText(QCoreApplication.translate("MainWindow", u"\u5168\u90e8\u5f00\u59cb", None))
        self.head_label.setText("")
        self.link_type_selector.setText(QCoreApplication.translate("MainWindow", u"video", None))
        self.link_line.setText(QCoreApplication.translate("MainWindow", u"113696558814120", None))
        self.name_label.setText(QCoreApplication.translate("MainWindow", u"Not Login", None))
