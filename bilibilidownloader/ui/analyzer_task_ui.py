...
class Ui_AnalyzerTask(object):
    def setupUi(self, AnalyzerTask):
        if not AnalyzerTask.objectName():
            AnalyzerTask.setObjectName(u"AnalyzerTask")
        ...
        self.audio_text.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.audio_select = QToolButton(AnalyzerTask)
        self.audio_select.setObjectName(u"audio_select")
        self.audio_select.setEnabled(True)
        self.audio_select.setGeometry(QRect(550, 80, 161, 32))
        self.audio_select.setPopupMode(QToolButton.ToolButtonPopupMode.MenuButtonPopup)
        self.video_text = QLabel(AnalyzerTask)
        self.video_text.setObjectName(u"video_text")
        self.video_text.setEnabled(True)
        self.video_text.setGeometry(QRect(300, 80, 40, 32))
        self.video_text.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.video_select = QToolButton(AnalyzerTask)
        self.video_select.setObjectName(u"video_select")
        self.video_select.setEnabled(True)
        self.video_select.setGeometry(QRect(340, 80, 161, 32))
        self.video_select.setPopupMode(QToolButton.ToolButtonPopupMode.MenuButtonPopup)
        self.select_check = QCheckBox(AnalyzerTask)
        self.select_check.setObjectName(u"select_check")
        self.select_check.setEnabled(True)
        self.select_check.setGeometry(QRect(930, 0, 60, 120))
        self.select_check.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.select_check.setStyleSheet(u"QCheckBox::indicator{\n"
"	width: 60px;\n"
"	height : 116px;\n"
"}\n"
"QCheckBox::hover{\n"
...
"}")
        ...
        self.vname_label.setObjectName(u"vname_label")
...
"}")
        ...
        self.time_text.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.error_label.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.error_label.setStyleSheet(u"QLabel{\n"
"	color: #d63031;\n"
"}")
        self.info_fetch_btn = QPushButton(AnalyzerTask)
        self.info_fetch_btn.setObjectName(u"info_fetch_btn")
    ...
    def retranslateUi(self, AnalyzerTask):
        AnalyzerTask.setWindowTitle(QCoreApplication.translate("AnalyzerTask", u"Form", None))
        self.thumbnail_label.setText(QCoreApplication.translate("AnalyzerTask", u"Loading ...", None))
        self.id_label.setText(QCoreApplication.translate("AnalyzerTask", u"1000", None))
        self.audio_text.setText(QCoreApplication.translate("AnalyzerTask", u"\u97f3\u8d28\uff1a", None))
        self.audio_select.setText(QCoreApplication.translate("AnalyzerTask", u"loading ...", None))
        self.video_text.setText(QCoreApplication.translate("AnalyzerTask", u"\u753b\u8d28\uff1a", None))
        self.video_select.setText(QCoreApplication.translate("AnalyzerTask", u"loading ...", None))
        self.select_check.setText("")
        self.vname_label.setText(QCoreApplication.translate("AnalyzerTask", u"Video Name", None))
        self.title_label.setText(QCoreApplication.translate("AnalyzerTask", u"Video Name", None))
        self.fmt_text.setText(QCoreApplication.translate("AnalyzerTask", u"\u683c\u5f0f\uff1a", None))
        self.fmt_select.setText(QCoreApplication.translate("AnalyzerTask", u"loading ...", None))
        self.time_text.setText(QCoreApplication.translate("AnalyzerTask", u"\u65f6\u957f\uff1a", None))
        self.time_label.setText(QCoreApplication.translate("AnalyzerTask", u"1:10:51", None))
        self.error_label.setText("")
        self.info_fetch_btn.setText(QCoreApplication.translate("AnalyzerTask", u"Info Re-Fetch", None))
    # retranslateUi
